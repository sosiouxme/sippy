...
func (tc Count) ToTestStats(flakeAsFailure bool) Stats { // translate to sippy/stats-land
	return NewStats(tc.SuccessCount, tc.Failures(), tc.FlakeCount, flakeAsFailure)
}
...
func NewStats(successCount, failureCount, flakeCount int, flakesAsFailure bool) Stats {
	return Stats{
