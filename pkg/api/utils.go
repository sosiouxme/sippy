...
func VariantsStringToSet(allJobVariants componentreport.JobVariants, variantsString string) (sets.String, error) {
...
func VariantListToMap(allJobVariants componentreport.JobVariants, variants []string) (map[string][]string, error) {
