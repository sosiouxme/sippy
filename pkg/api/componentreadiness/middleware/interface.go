...
type Middleware interface {
	...
	PreAnalysis(testKey tier1.ReportTestIdentification, testStats *testdetails.TestComparison) error
	...
	PostAnalysis(testKey tier1.ReportTestIdentification, testStats *testdetails.TestComparison) error
