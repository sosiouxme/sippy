...
type Middleware interface {
	...
	Query(ctx context.Context, wg *sync.WaitGroup, allJobVariants test.JobVariants,
	...
	QueryTestDetails(ctx context.Context, wg *sync.WaitGroup, errCh chan error, allJobVariants test.JobVariants)
	...
	PreAnalysis(testKey test.ReportTestIdentification, testStats *testdetails.TestComparison) error
	...
	PostAnalysis(testKey test.ReportTestIdentification, testStats *testdetails.TestComparison) error
