...
func TestParseComponentReportRequest(t *testing.T) {
	...
	allJobVariants := test.JobVariants{Variants: map[string][]string{
	...
	view417main := view.View{
		Name: "4.17-main",
		BaseRelease: requestoptions.RequestRelativeReleaseOptions{
		...
		VariantOptions: requestoptions.RequestVariantOptions{
			ColumnGroupBy:   defaultColumnGroupByVariants,
			DBGroupBy:       defaultDBGroupByVariants,
			IncludeVariants: includeVariants,
		},
		AdvancedOptions: requestoptions.RequestAdvancedOptions{
			MinimumFailure:   3,
			Confidence:       95,
			PityFactor:       5,
			IgnoreMissing:    false,
	...
	view417cross.VariantOptions = requestoptions.RequestVariantOptions{
